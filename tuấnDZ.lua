...
local Tabs = {
    ...
    Status =  Window:AddTab({ Tile = "Status", Icon = "rbxassetid://7040410130" }),
--------------------------------------------------------------------
}
...
Status:Label("Name : "..game.Players.LocalPlayer.Name)



if W then
Status:Label("World : 1")
end

if W2 then
Status:Label("World : 2")
end

if W3 then
Status:Label("World : 3")
end

Status:Label("Race : "..game:GetService("Players").LocalPlayer.Data.Race.Value)

Status:Label("Fruit : "..game.Players.LocalPlayer.Data.DevilFruit.Value)

Status:Label("Level : "..game.Players.localPlayer.Data.Level.Value)

Status:Label("Bounty : "..game:GetService("Players").LocalPlayer.leaderstats["Bounty/Honor"].Value)
